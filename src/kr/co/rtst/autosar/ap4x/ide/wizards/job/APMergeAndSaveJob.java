...
public class APMergeAndSaveJob extends Job {
    ...
    public APMergeAndSaveJob(List<GReferrable> autosarModels, URI targetURI, TransactionalEditingDomain editingDomain, IMetaModelDescriptor descriptor)
    {
        super(NAME);
    ...
    {
//        Workspaces.waitForAutoBuildAndModelLoad();
...
//            final MergeAndSaveJob this$0;
//
//            
//            {
//                this$0 = MergeAndSaveJob.this;
//                super();
//            }
        };
//;
