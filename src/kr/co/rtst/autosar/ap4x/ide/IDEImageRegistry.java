...
public class IDEImageRegistry {
	...
	public Image getImage(String imageFilePath){
		...
		if(image == null){
			...
			image = IDEActivator.getImageDescriptor(imageFilePath).createImage();
	...
	public ImageDescriptor getImageDescriptor(String imageFilePath){
		...
		if(imageDesc == null){
			// 새로운 이미지의 요청이므로 생성하여 등록한다.
			imageDesc = IDEActivator.getImageDescriptor(imageFilePath);
	...
	public Image getImage(String pluginId, String imageFilePath){
		...
		if(image == null){
			// 새로운 이미지의 요청이므로 생성하여 등록한다.
			image = IDEActivator.imageDescriptorFromPlugin(pluginId, imageFilePath).createImage();
	...
	public ImageDescriptor getImageDescriptor(String pluginId, String imageFilePath){
		...
		if(imageDesc == null){
			// 새로운 이미지의 요청이므로 생성하여 등록한다.
			imageDesc = IDEActivator.imageDescriptorFromPlugin(pluginId, imageFilePath);
